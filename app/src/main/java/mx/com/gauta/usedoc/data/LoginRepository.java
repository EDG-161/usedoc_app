...
public class LoginRepository {
    ...
    public Result<JSONObject> login(String username, String password) {
        ...
        if (result instanceof Result.Success) {
            try {
                setLoggedInUser(new LoggedInUser(((Result.Success<JSONObject>) result).getData().getString("name_usr"),((Result.Success<JSONObject>) result).getData().getString("name_usr")));
